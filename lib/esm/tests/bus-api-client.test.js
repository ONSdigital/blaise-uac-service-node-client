...
describe("busApiClientTest", function () {
    ...
    describe("get all disabled UACs for an instrument", function () {
        beforeEach(function () {
            mock.onGet("http://" + busApiUrl + "/uacs/uac/" + instrumentName + "/disabled").reply(200, InstrumentUacDetailsMock);
        });
        afterEach(function () {
            mock.reset();
        });
        it("returns a dictionary of all disabled UACs associated to the instrument", function () { return __awaiter(void 0, void 0, void 0, function () {
            var instruments;
            return __generator(this, function (_a) {
                switch (_a.label) {
