...
var bus_api_client_1 = __importStar(require("../bus-api-client"));
...
var uac = "5678";
var busApiClientTest = new bus_api_client_1.default("http://" + busApiUrl, busClientId);
describe("busApiClientTest", function () {
    describe("generate UAC codes for an instrument from a list of case IDs", function () {
        ...
        beforeEach(function () {
            mock.onPost("http://" + busApiUrl + "/uacs/generate").reply(201, bus_api_client_1.InstrumentUacDetailsMock);
        });
        afterEach(function () {
            mock.reset();
        });
        it("Generates UACs for all cases contained within the instrument", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        instrument = _a.sent();
                        expect(instrument).toEqual(bus_api_client_1.InstrumentUacDetailsMock);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe("generate UAC codes for an instrument", function () {
        beforeEach(function () {
            mock.onPost("http://" + busApiUrl + "/uacs/instrument/" + instrumentName).reply(201, bus_api_client_1.InstrumentUacDetailsMock);
        });
        afterEach(function () {
            mock.reset();
        });
    ...
    describe("get all UAC details for an instrument", function () {
        beforeEach(function () {
            mock.onGet("http://" + busApiUrl + "/uacs/instrument/" + instrumentName).reply(200, bus_api_client_1.InstrumentUacDetailsMock);
        });
        afterEach(function () {
            mock.reset();
        });
        it("returns a dictionary of all UAC details associated to the instrument with the UAC as the index", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        instruments = _a.sent();
                        expect(instruments).toEqual(bus_api_client_1.InstrumentUacDetailsMock);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe("get all UAC details for an instrument by Case ID", function () {
        beforeEach(function () {
            mock.onGet("http://" + busApiUrl + "/uacs/instrument/" + instrumentName + "/bycaseid").reply(200, bus_api_client_1.InstrumentUacDetailsByCaseIdMock);
        });
        afterEach(function () {
            mock.reset();
        });
        it("returns a dictionary of all UAC details associated to the instrument with the Case ID as the index", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        instruments = _a.sent();
                        expect(instruments).toEqual(bus_api_client_1.InstrumentUacDetailsByCaseIdMock);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe("get all disabled UACs for an instrument", function () {
        beforeEach(function () {
            mock.onGet("http://" + busApiUrl + "/uacs/uac/" + instrumentName + "/disabled").reply(200, bus_api_client_1.InstrumentDisabledUacDetailsMock);
        });
        afterEach(function () {
            mock.reset();
        });
        it("returns a dictionary of all disabled UAC details associated to the instrument", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        instruments = _a.sent();
                        expect(instruments).toEqual(bus_api_client_1.InstrumentDisabledUacDetailsMock);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe("disable uac", function () {
        ...
        it("returns no error messages to indicate it was successful", function () { return __awaiter(void 0, void 0, void 0, function () {
            var disableUacResponse;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, busApiClientTest.disableUac("5678")];
                    case 1:
                        disableUacResponse = _a.sent();
    ...
    describe("enable uac", function () {
        ...
        it("returns no error messages to indicate it was successful", function () { return __awaiter(void 0, void 0, void 0, function () {
            var enableUacResponse;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, busApiClientTest.enableUac("5678")];
                    case 1:
                        enableUacResponse = _a.sent();
